...
<br>
                            <table id="table2" class="table table-hover">
                                ...
                                <tbody>
 <?php 
  $checkinData =$this->Package_model->Reportbooking();
