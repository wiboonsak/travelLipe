   ...
   alert('Select atleast one records');
	...
	function delete_data(dataID,table){  
		swal({
		   ...
		   $.post('<?php echo base_url('PackageCMS/deleteData4')?>' , { dataID : dataID , table : table }, 
			function(data){
				if(data==1){ 
                	swal({
		...
		var datepicker1 = $('#datepicker1').val();				
			...
			$.post('<?php echo base_url('PackageCMS/searchdata')?>' , { SearchBooking : SearchBooking , datepicker1 : datepicker1 } , function(data){ 
